...
def deploy_lambdas():
    ...
    create_lambdas(permit,deploy,process_payments_lambda_name,process_payments_role)
    create_lambdas(permit,deploy,process_purchases_lambda_name,process_purchases_role)
    create_lambdas(permit,deploy,process_sales_lambda_name,process_sales_role)
...
def create_lambdas(permit:Assign_iam,deploy:Deploy_lambdas,lambda_name,role_name):
    deploy.create_lambda(lambda_name=lambda_name, code_bucket=code_bucket_name, role_arn=permit.role_arns[role_name],zip_file=f'{lambda_name}.zip')
